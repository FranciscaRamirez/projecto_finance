#Función para crear una cuenta con un ID autoincremental, utilizando listas en lugar de diccionarios
...
#Función para agregar una transacción a una cuenta específica
...
# Salimos del bucle una vez que se ha agregado la transacción            
            break
#Función para agregar una transacción a una cuenta específica, toma los valores los ingresa, los carga, los suma y los resta
...
# Función para obtener el saldo total de todas las cuentas
